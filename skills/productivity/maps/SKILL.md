...
Script path: `/Users/batcave/.hermes/skills/productivity/maps/scripts/maps_client.py`

If using `~`, include the category directory: `~/.hermes/skills/productivity/maps/scripts/maps_client.py`.

## Commands

```bash
MAPS=/Users/batcave/.hermes/skills/productivity/maps/scripts/maps_client.py
# Portable alternative after loading the skill: use skill_dir + /scripts/maps_client.py
```
...
```bash
python3 /Users/batcave/.hermes/skills/productivity/maps/scripts/maps_client.py search "Statue of Liberty"
# Should return lat ~40.689, lon ~-74.044

python3 /Users/batcave/.hermes/skills/productivity/maps/scripts/maps_client.py nearby --near "Times Square" --category restaurant --limit 3
